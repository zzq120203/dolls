...
class JedisSentinelPoolMini extends JedisPoolAbstractMini {
    ...
    private volatile JedisFactoryMini factory;
    private volatile HostAndPort currentHostMaster;

    private final Object initPoolLock = new Object();

    public JedisSentinelPoolMini(String masterName, Set<String> sentinels,
    ...
    private void initPool(HostAndPort master) {
        synchronized(initPoolLock){
            if (!master.equals(currentHostMaster)) {
                ...
                if (factory == null) {
                    factory = new JedisFactoryMini(master.getHost(), master.getPort(), connectionTimeout,
    ...
    protected class MasterListener extends Thread {
        ...
        protected volatile JedisMini j;
        ...
        public void run() {
            ...
            while (running.get()) {
                ...
                try {
                    ...
                    j = new JedisMini(host, port, sentinelConnectionTimeout, sentinelSoTimeout);
                    if (sentinelUser != null) {
